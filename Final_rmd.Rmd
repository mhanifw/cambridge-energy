...
```{r}
labels1 <-
  str_replace_all(string = energyuse$property_type,
                  pattern = c("Residence Hall/Dormitory",
                              "Vocational School"
                             ),
                  replacement = "College/University")

labels2 <-
  str_replace_all(string = labels1,
                  pattern = c("Residence Hall/Dormitory",
                              "Vocational School",
                              "Data Center",
                              "Financial Office",
...
labels3 <-
  str_replace_all(string = labels2,
                  pattern = c("Mixed Use Property",
...
labels4 <-
  str_replace_all(string = labels3,
                  pattern = c("Worship Facility",
                              "Fire Station",
...
labels5 <-
  str_replace_all(string = labels5,
                  pattern = c("Other - Education",
